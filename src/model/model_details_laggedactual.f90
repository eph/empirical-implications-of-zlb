...
!> @brief NK model similar to CEE or SW. Uses lagged actual rate in the policy rule.
!-----------------------------------------------------------------------------------------------------------------
...
if ( (endogvar(9) .lt. 1.0d0) .and. (poly%zlbswitch .eqv. .true.) ) then  !zlb case
   zlbintermediate = .true.
   omegapoly = exp(omegaweight*log(endogvar(9))) !now omegapoly and funcapp_plus relevant
...
!(1) cap, (2) cc, (3) inv, (4) rw, (5) nomr, (6) dp, (7) gdp, (8) xhp, (9) notr, (10) lam, (11) qq, (12) lab, (13) util, (14) mc, (15) rentalk, (16) muc
...
double precision :: dpm1,rwm1,capm1,invm1,ccm1,gdpm1,nomrm1
...
notr = exp( lrss+gam_rs*(log(nomrm1)-lrss) + (1.0d0-gam_rs)*( gam_dp*log(dp/pibar)  +&
...
!(1) cap, (2) cc, (3) inv, (4) rw, (5) nomr (6) dp, (7) gdp, (8) xhp, (9) notr, (10) lam, (11) qq, 
...
endogvar = (/cap, cc, inv, rw, nomr, dp, gdp, xhp, notr, lam, &
...
ep = params(9)
exp_eul(1) =  (params(1)/params(3))*liqshk*endogvar(5)*exp_var(1)
...
if ((zlbinfo .ne. 0) .and. (poly%zlbswitch .eqv. .true.)) then
   exp_eul(7) =  (params(1)/params(3))*liqshk*endogvarzlb(5)*exp_var(7)
